...
if (count($errors) == 0) {
	...
	$query = "INSERT INTO events (subject, description, file)
...
?>
	  			<h2 class="admin-title">Add Event</h2> 
				  ...
				  <?php include("../../app/database/errors.php"); ?>
	  				...
	  				<div>
	  					<button type="submit" name="add_event" class="btn btn-big">Add Event</button>
	  				</div>
